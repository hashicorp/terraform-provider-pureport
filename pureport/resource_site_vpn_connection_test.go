		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "gateways.0.customer_ip", "169.254.1.1/30"),
					resource.TestCheckResourceAttr(resourceName, "gateways.0.pureport_asn", "394351"),
					resource.TestCheckResourceAttr(resourceName, "gateways.0.pureport_ip", "169.254.1.2/30"),
					...
					resource.TestCheckResourceAttr(resourceName, "gateways.1.name", "SITE_IPSEC_VPN"),
					...
					resource.TestCheckResourceAttr(resourceName, "gateways.1.customer_ip", "169.254.2.1/30"),
					resource.TestCheckResourceAttr(resourceName, "gateways.1.pureport_asn", "394351"),
					resource.TestCheckResourceAttr(resourceName, "gateways.1.pureport_ip", "169.254.2.2/30"),
