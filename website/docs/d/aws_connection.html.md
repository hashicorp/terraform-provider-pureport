...
sidebar_current: "docs-pureport-datasource-aws_connection"
description: |-
  Manages a Pureport AWS Direct Connect Connection.
---

# Data Source: pureport\_aws\_connection
...
* `aws_region` - The AWS region to create your connection.
...
* `peering_type` - The peering type to to use for the connection:
    * PRIVATE
    * PUBLIC
* `cloud_service_hrefs` - When PUBLIC peering is configured, a list of HREFs for the Public peering services to which we want access.
